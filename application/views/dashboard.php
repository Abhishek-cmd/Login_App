...
<html lang="en">
    ...
    <head>
        ...
        <!-- MetisMenu CSS -->
        <link href="<?php echo base_url(); ?>application/public/css/metisMenu.min.css" rel="stylesheet">

        <!-- Timeline CSS -->
        <link href="<?php echo base_url(); ?>application/public/css/timeline.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="<?php echo base_url(); ?>application/public/css/startmin.css" rel="stylesheet">

        <!-- Morris Charts CSS -->
        <link href="<?php echo base_url(); ?>application/public/css/morris.css" rel="stylesheet">

        <!-- Custom Fonts -->
        <link href="<?php echo base_url(); ?>application/public/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <script src="<?php echo base_url(); ?>application/public/js/jquery.min.js"></script>

        <!-- Bootstrap Core JavaScript -->
        <script src="<?php echo base_url(); ?>application/public/js/bootstrap.min.js"></script>

        <!-- Metis Menu Plugin JavaScript -->
        <script src="<?php echo base_url(); ?>application/public/js/metisMenu.min.js"></script>

        <!-- Morris Charts JavaScript -->
        <script src="<?php echo base_url(); ?>application/public/js/raphael.min.js"></script>
        <script src="<?php echo base_url(); ?>application/public/js/morris.min.js"></script>
        <script src="<?php echo base_url(); ?>application/public/js/morris-data.js"></script>

        <!-- Custom Theme JavaScript -->
        <script src="<?php echo base_url(); ?>application/public/js/startmin.js"></script>
